...
<!-- Mirrored from sagtele.com/sag/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 15:51:53 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    
        <meta charset="utf-8">
        <meta http-equiv="x-ua-compatible" content="ie=edge">
        <title>About Us - SubForMe</title>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12 ">
						<div class="single-about mb-30">
							<center><h1> <span style="color: #d32535;">About Us</span></h1></center>
						</div>
					</div>
					<div class="col-md-6 col-sm-6 ">
						<div class="single-about mb-30">
							<div class="about-text">
								<h4>The Golden Opportunities</h4>
								<p>
									<strong>SubForMe</strong> is a Telecommunication Company that deals with subscription of Data, Airtime VTU, Cable Tv, Electricity And Education Bills. It provides opportunity for every individual to become a CEO of Global Telecommunication Bussiness.  
								</p>
								<br/>
					...
					<div class="col-md-6 col-sm-6">
						<div class="single-about mb-30">
							<div class="about-text">
								<img src="img/subandgain_vtu.jpg">
							</div>
							<br/>
							<div class="our-skill">
								<h6 class="progress-title">AFFORDABILITY <span class="pull-right"><span>90</span>%</span></h6>
								<div class="progress">
									<div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100" style="width: 90%;">
									</div>
								</div>
								<h6 class="progress-title">SPEED<span class="pull-right"><span>98</span>%</span></h6>
								<div class="progress">
									<div class="progress-bar" role="progressbar" aria-valuenow="98" aria-valuemin="0" aria-valuemax="100" style="width: 98%;">
									</div>
								</div>
								<h6 class="progress-title">CHAT SUPPORT<span class="pull-right"><span>100</span>%</span></h6>
								<div class="progress">
...
<!-- Mirrored from sagtele.com/sag/about.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 May 2023 15:51:54 GMT -->
</html>
